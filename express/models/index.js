// express/models/index.js (v3.1 - Case-Sensitivity Hotfix)
'use strict';
...
// db.ManualReport = require('./ManualReport.js')(sequelize, Sequelize.DataTypes); // 如有此檔案，請取消註解
// db.Payment = require('./Payment.js')(sequelize, Sequelize.DataTypes); // 如有此檔案，請取消註解
