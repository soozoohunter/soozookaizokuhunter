...
module.exports = {
  async up (queryInterface, Sequelize) {
    const plans = [
      ...
      {
        plan_code: 'BASIC', name: '創意守護者', monthly_price: 490, annual_price: 4900,
      ...
      {
        plan_code: 'PRO', name: '專業捍衛者', monthly_price: 790, annual_price: 7900,
        works_quota: 300, scan_quota_monthly: 30, dmca_quota_monthly: 3,
        scan_frequency: '72h', has_batch_processing: true, has_trademark_monitoring: true, has_p2p_engine: true, has_legal_consultation: false,
        createdAt: new Date(), updatedAt: new Date()
      },
      {
        plan_code: 'ELITE', name: '全方位守護者', monthly_price: 1490, annual_price: 14900,
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.bulkDelete('subscription_plans', { plan_code: ['FREE', 'BASIC', 'PRO', 'ELITE'] });
  }
};
